...
def main():
    ...
    model_audio_visual = MLPClassifier(hidden_layer_sizes=(100,), activation="relu", solver="adam", max_iter=max_iter)
    model_audio_visual.fit(feat_audio_visual, cats)
    ...
    model_double = {
        'audio': model_audio,
        'visual': model_visual,
        'audio_visual': model_audio_visual,
        'fusion': model_fusion,
    }
    with open(model_file, 'wb') as f:
        pickle.dump(model_double, f)
    return
